...
- add telemetry dashboards for recommendation retries and cache hits
- add a user feedback button for recommendation helpfulness
- add evaluation fixtures for all 6 class/activity combinations
- add richer admin tooling for activity labeling and note authoring
- add a production deployment path once local development is stable
